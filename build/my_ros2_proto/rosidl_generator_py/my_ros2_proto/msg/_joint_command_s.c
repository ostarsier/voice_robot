...
bool my_ros2_proto__msg__joint_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_ros2_proto.msg._joint_command.JointCommand", full_classname_dest, 45) == 0);
  }
  my_ros2_proto__msg__JointCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // stiffness
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->stiffness.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'stiffness'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // damping
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->damping.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'damping'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * my_ros2_proto__msg__joint_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_ros2_proto.msg._joint_command");
  ...
  {  // stiffness
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "stiffness");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->stiffness.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->stiffness.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->stiffness.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // damping
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "damping");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->damping.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->damping.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->damping.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
